...
const ProductImage = ({
  ...
  if (viewMode === "list") {
    return (
      <div className="w-32 h-30 flex-shrink-0 relative mr-4 overflow-hidden rounded">
        <motion.div
  ...
  >
    <div className="flex">
      ...
      <div className="flex-1 min-w-0 py-2">
        <h3 className="font-semibold text-emerald-600 text-sm mb-1 line-clamp-1 group-hover:text-emerald-600 transition-colors">
          {formatPrice(product.price)}
        </h3>
